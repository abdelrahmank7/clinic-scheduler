import {
  ...
  require_toKey,
  scrollbarSize
} from "./chunk-BRXXTQST.js";
import {
  require_prop_types
} from "./chunk-XBRYKRTD.js";
import {
  require_react_dom
} from "./chunk-42DVMF4H.js";
import {
  require_react
  ...
  return _createClass(BackgroundCells2, [{
    ...
    value: function render() {
      ...
      return import_react25.default.createElement("div", {
        ...
        var _getters$dayProp = getters.dayProp(date2), className = _getters$dayProp.className, style = _getters$dayProp.style;
...
var getKey = function getKey2(_ref) {
...
function TimeGridEvent(props) {
  var style = props.style, className = props.className, event = props.event, accessors = props.accessors, rtl = props.rtl, selected = props.selected, label = props.label, continuesPrior2 = props.continuesPrior, continuesAfter2 = props.continuesAfter, getters = props.getters, onClick = props.onClick, onDoubleClick = props.onDoubleClick, isBackgroundEvent = props.isBackgroundEvent, onKeyPress = props.onKeyPress, _props$components = props.components, Event2 = _props$components.event, EventWrapper = _props$components.eventWrapper;
  var title = accessors.title(event);
  var tooltip = accessors.tooltip(event);
  var end2 = accessors.end(event);
  var start2 = accessors.start(event);
  ...
  var height2 = style.height, top2 = style.top, width = style.width, xOffset = style.xOffset;
...
var DayColumn = function(_React$Component) {
  ...
  return _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      var _dayProp = dayProp(max3, resource), className = _dayProp.className, style = _dayProp.style;
  ...
  return _createClass(TimeGridHeader2, [{
    ...
    value: function renderHeaderCells(range2) {
      ...
      return range2.map(function(date2, i) {
        ...
        var _dayProp = dayProp(date2), className = _dayProp.className, style = _dayProp.style;
